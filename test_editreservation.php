...
<body>
    ...
    <div class="reservation-form">
        <form class="row g-3" method="post">
            <?php
            $id = $_GET['id'];
            $updatesql = "SELECT KUNDE.Name, KUNDE.Telefon, RESERVIERUNG.Datum, RESERVIERUNG.Zeit, TISCH.TischID FROM RESERVIERUNG LEFT JOIN KUNDE ON RESERVIERUNG.KundeID=KUNDE.KundeID LEFT JOIN TISCH ON RESERVIERUNG.ReservierungNr=TISCH.ReservierungNr WHERE RESERVIERUNG.ReservierungNr=$id";
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" id="table" name="table" value=<?php echo $data['TischID']; ?> required>
                    ...
                    <?php
                    /**$sql= "SELECT TischID FROM `TISCH` WHERE Status='Available'";
